...
/**
 * Parameters for the Dingocoin testnet, a separate public network that has
 * relaxed rules suitable for development and testing of applications and new
 * Dingocoin versions.
 */
public class DingocoinTestNet3Params extends AbstractDingocoinParams {
    ...
    public DingocoinTestNet3Params() {
        ...
        // chain agnostic. Dingocoin mainnet has its own headers for legacy reasons.
        bip32HeaderP2PKHpub = 0x043587CF;
        bip32HeaderP2PKHpriv = 0x04358394;
    }

    private static DingocoinTestNet3Params instance;
    public static synchronized DingocoinTestNet3Params get() {
        if (instance == null) {
            instance = new DingocoinTestNet3Params();
        }
        return instance;
    }
