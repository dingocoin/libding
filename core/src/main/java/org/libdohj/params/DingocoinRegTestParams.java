...
/**
 * Network parameters for the regression test mode of dingocoin in which all blocks are trivially solvable.
 */
public class DingocoinRegTestParams extends DingocoinTestNet3Params {
    ...
    public Block getGenesisBlock() {
        synchronized (DingocoinRegTestParams.class) {
            if (genesis == null) {
    ...
    private static DingocoinRegTestParams instance;

    public static synchronized DingocoinRegTestParams get() {
        if (instance == null) {
            instance = new DingocoinRegTestParams();
        }
        return instance;
    }
